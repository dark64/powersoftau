...
fn main() {
    ...
    let original_parameters = CeremonyParams::<Bn256>::new(original_circuit_power, batch_size);
    ...
    reduced_accumulator.tau_powers_g1 =
        current_accumulator.tau_powers_g1[..original_parameters.powers_g1_length].to_vec();
    reduced_accumulator.tau_powers_g2 =
        current_accumulator.tau_powers_g2[..original_parameters.powers_length].to_vec();
    reduced_accumulator.alpha_tau_powers_g1 =
        current_accumulator.alpha_tau_powers_g1[..original_parameters.powers_length].to_vec();
    reduced_accumulator.beta_tau_powers_g1 =
        current_accumulator.beta_tau_powers_g1[..original_parameters.powers_length].to_vec();
    ...
    let hash = reduced_hash(original_circuit_power as u8, reduced_circuit_power as u8);
    (&mut writable_map[0..])
