...
# cargo run --release --bin reduce_powers challenge4 challenge_reduced $SIZE 8 $BATCH
# cargo run --release --bin beacon_constrained challenge_reduced response_reduced 8 $BATCH 0000000000000000000a558a61ddc8ee4e488d647a747fe4dcc362fe2026c620 10
# cargo run --release --bin prepare_phase2 response_reduced 8 $BATCH
